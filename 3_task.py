...
firstPoint= list(map(int, input("Введите координаты первой точки x y z через пробел:").split()))
secondPoint= list(map(int, input("Введите координаты второй точки x y z через пробел:").split()))
